        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav">
                <li id="links" class="nav-item active">
                    <a class="nav-link text-white" href="?c=producto&a=Index">Home</a>
                </li>
                <li id="links" class="nav-item">
                    <a class="nav-link text-white" href="?c=producto&a=Listar_Productos">Productos</a>
                </li>
                <li id="links" class="nav-item">
                    <a class="nav-link text-white" href="?c=usuario&a=Nosotros">Nosotros</a>
                </li>
                <li id="links" class="nav-item">
                    <a class="nav-link text-white" href="?c=usuario&a=Contacto">Contacto</a>
                </li>
            </ul>
